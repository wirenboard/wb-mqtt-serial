...
- [Файл конфигурации и шаблоны](#Файл-конфигурации-и-шаблоны)
  ...
  - [Группировка каналов и параметров](#Группировка-каналов-и-параметров)
  - [Настройка отображения параметров в веб-конфигураторе](#Настройка-отображения-параметров-в-веб-конфигураторе)
...
- [Особенности работы драйвера](#Особенности-работы-драйвера)
  - [Таймауты и количество неудачных цикловя](#Таймауты-и-количество-неудачных-циклов)  
...
- [Протоколы](#Протоколы)
  ...
  - [DLMS/COSEM, СПОДЭС](#DLMS/COSEM--СПОДЭС)
  - [Somfy SDN](#Somfy-SDN)
  - [WinDeco](#WinDeco)
  - [Dooya](#Dooya)
...
Пример шаблона с описанием параметров:
```jsonc
{
...
```
Шаблоны описаний устройств при установке пакета расположены в папке `/usr/share/wb-mqtt-serial/templates`. Если необходимо создать шаблон нового устройства, надо сохранить его в папке `/etc/wb-mqtt-serial.conf.d/templates`, она предназначена для пользовательских шаблонов.
...
## Настройка отображения параметров в веб-конфигураторе
