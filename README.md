        ...
        "parameters": [
            {
                ...
                // Признак того, что значение параметра может изменяться динамически.
                // Значения таких параметров не будут кэшироваться и будут повторно считаны при каждом вызове RPC Device/LoadConfig.
                "no_cache": true
            }
        ],
