    ...
    "ports": [
        {
            ...
            // Параметр устройства в веб-интерфейсе: Таймаут ответа (мс)
            ...
            // Параметр устройства в веб-интерфейсе: Дополнительная задержка перед записью в порт (мкс)
            ...
            "devices": [
                {
                    ...
                    // отображаемое имя устройства. Публикуется как
                    // .../meta/name в MQTT
                    // Параметр устройства в веб-интерфейсе: Название устройства
                    "name": "MSU34+TLP",
                    ...
                    // topic'и, относящиеся в MQTT к данному устройству,
                    // имеют общий префикс /devices/<идентификатор топика>/...
                    // Параметр устройства в веб-интерфейсе: Идентификатор устройства в MQTT
                    "id": "msu34tlp",
                    ...
                    // "enabled": false опрос устройства и запись значений
                    // его каналов не происходит. По умолчанию - true.
                    // Параметр устройства в веб-интерфейсе: Опрашивать устройство
                    "enabled": true,
                    ...
                    // устройствами Modbus.
                    // Параметр устройства в веб-интерфейсе: Максимальное число считываемых промежуточных регистров
                    "max_reg_hole": 10,
                    ...
                    // Параметр устройства в веб-интерфейсе: Максимальное число считываемых промежуточных бит
                    "max_bit_hole": 80,
                    ...
                    // Параметр устройства в веб-интерфейсе: Максимальное число регистров, считываемых за один запрос
                    ...
                    // Параметр устройства в веб-интерфейсе: Минимальное число регистров, считываемых за один запрос
                    ...
                    // Параметр устройства в веб-интерфейсе: Максимальное число регистров, записываемых за один запрос
                    ...
                    // Этот параметр задан в шаблонах описания устройств, переопределять его можно только в случае некорректной работы с устройством.
                    // По умолчанию 20 мс
                    // Параметр устройства в веб-интерфейсе: Задержка между сообщениями (мс)
                    ...
                    // По умолчанию false
                    // Параметр устройства в веб-интерфейсе: Разделять сообщения по времени
                    ...
                    // Параметр устройства в веб-интерфейсе: Время ожидания устройства (мс)
                    ...
                    // Запрещает переподключение, если установлено -1.
                    // Параметр устройства в веб-интерфейсе: Максимальное число неудачных циклов опроса
                    ...
                    // Параметр устройства в веб-интерфейсе: Время повторных попыток записать регистр (с)
                    ...
                    // Параметр устройства в веб-интерфейсе: Пароль в виде массива байт
                    "password": [1, 2, 3],

                    // уровень доступа при опросе устройства,
                    // используется для обмена с счётчиками электроэнергии
                    // Параметр устройства в веб-интерфейсе: Уровень доступа
                    "access_level": 1,
