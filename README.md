...
|Параметр   |Тип          |Значение по умолчанию |Описание |
|-----------|-------------|----------------------|---------|
|`path`     |обязательный |                      |путь к последовательному порту, в который будет отправлено сообщение
...
|Параметр |Тип          |Значение по умолчанию |Описание |
|---------|-------------|----------------------|---------|
|`ip`     |обязательный |                      |IP-адрес клиента, которому будет отправлено сообщение
|`port`   |обязательный |                      |номер порта на указанном адресе клиента
