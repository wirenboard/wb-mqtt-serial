...
Для совместимости со старыми шаблонами перевод ищется сначала по идентификатору, а затем по заданному в шаблоне `title`. Поэтому шаблоны, в которых ключом перевода служит английский текст из `title`, продолжают работать без изменений.
