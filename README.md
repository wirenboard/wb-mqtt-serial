...
Коллизии идентификаторов устройств
----------------------------------

В случае если присутствуют утройства с одинаковыми идентификаторами драйвер для всех таких устройств добавит к id
индекс порта, который зависит от расположения его конфигурации в массиве в файле конфигурации
если устройства расположены на разных портах

Коллизии имен устройств
-----------------------

В случае если присутствуют утройства с одинаковыми именами драйвер для всех таких устройств добавит к имени:
1) информацию о порте если устройства с одинаковыми именами расположены на разных портах
2) порядковый номер устройства если устройства с одинаковыми именами расположены на одном и том же порту
