                    ...
                    "channels": [
                        {
                            ...
                            //            Для протокола Modbus строки считываются по одному символу на регистр из младшего или старшего байта, в зависимости от значения параметра "byte_order" (по умолчанию используется млалший байт).
