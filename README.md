...
После возобновления опроса осуществляется повторная настройка устройства в соответсвии с шаблоном (запись регистров из секции инициализации, включение непрерывного чтения и т.д.)
