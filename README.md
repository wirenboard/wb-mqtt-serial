...
|`baud_rate`|обязательный |                      |скорость порта        |
|`parity`   |обязательный |                      |чётность - N, O или E |
|`data_bits`|обязательный |                      |количество бит данных |
|`stop_bits`|обязательный |                      |количество стоп-бит   |
