                    ...
                    "channels": [
                        {
                            ...
                            // Необязательные единицы измерения (строка), например "V", "A", "deg C", "kWh".
                            // Публикуются в MQTT как .../devices/<id>/controls/<id контрола>/meta/units
                            // и используются в правилах, виджетах и внешних интеграциях.
                            "units": "deg C",
...
```jsonc
{
    ...
    "device": {
        ...
        // Список каналов
        // У канала можно задать необязательное поле "units" — строку единиц измерения; оно попадает
        // в .../controls/<id>/meta/units в MQTT (рядом с type, readonly и др. в meta контрола).
        "channels": [
