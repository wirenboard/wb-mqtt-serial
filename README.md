...
|`write_address`   |опциональный |                      |адрес первого Modbus-регистра для записи, в случчае использования функции `23` (для других функций записи необходимо использовать параметр `address`)
|`write_count`     |опциональный | 1                    |число Modbus-регистров для записи, в случчае использования функции `23` (для других функций записи необходимо использовать параметр `count`)
