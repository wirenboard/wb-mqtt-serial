...
Драйвер Modbus запускается командой `/etc/init.d/wb-mqtt-serial start`
...
Устройства Uniel
-------------
В драйвере wb-mqtt-serial реализована поддержка некоторых устройств Uniel (smart.uniel.ru).
...
См. также: [пример конфигурационного файла](wb-mqtt-serial/config-uniel.json).
