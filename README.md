    ...
    "device": {
        ...
        "groups": [
            // Описание группы
            {
                ...
                // приносит своё описание группы. Действует объявление с наибольшей "fw" среди
                // поддержанных прошивкой устройства, объявление используется целиком, а не
                // дополняет предыдущее. Драйвер группы не обрабатывает, вариант выбирает
                // веб-интерфейс, поэтому нужен wb-mqtt-homeui не старше 2.252.0
                "fw": "1.2.3"
            },
            ...
        ]
