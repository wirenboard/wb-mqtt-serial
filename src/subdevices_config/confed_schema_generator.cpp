...
namespace
{
    ...
    Json::Value MakeTabOneOfChannelSchema(const Json::Value& channel)
    {
        ...
        for (const auto& subDeviceName: channel["oneOf"]) {
            Append(oneOf)["$ref"] = "#/definitions/" + Subdevices::GetSubdeviceSchemaKey(subDeviceName.asString());
        }
    ...
    Json::Value MakeTabSingleDeviceChannelSchema(const Json::Value& channel, bool disableTitle)
    {
        ...
        auto& allOf = MakeArray("allOf", r);
        Append(allOf)["$ref"] = "#/definitions/" + Subdevices::GetSubdeviceSchemaKey(channel["device_type"].asString());
        allOf.append(MakeHiddenNameObject(channel["name"].asString()));
        return r;
    }
    ...
    {
        Json::Value v = Subdevices::ConfigToHomeuiSubdeviceChannel(channel);
    ...
    {
        Json::Value& res = definitions[Subdevices::GetSubdeviceSchemaKey(subDeviceType)];
        res["type"] = "object";
        ...
        auto set = Subdevices::GetSubdeviceKey(subDeviceType);
...
void Subdevices::TransformGroupsToSubdevices(Json::Value& schema,
                                             Json::Value& subdevices,
                                             Json::Value* mainSchemaTranslations)
{
...
std::string Subdevices::GetSubdeviceSchemaKey(const std::string& subDeviceType)
{
    return GetHashedParam(subDeviceType, "d");
}

std::string Subdevices::GetSubdeviceKey(const std::string& subDeviceType)
{
...
//  }
Json::Value Subdevices::MakeDeviceSchemaForConfed(TDeviceTemplate& deviceTemplate,
