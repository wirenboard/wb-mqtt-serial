...
namespace
{
    ...
    public:
        ...
        {
            Expector()->Expect(
                ExpectVectorFromString("/?141628345!\r\n"),
        ...
        {
            Expector()->Expect(
                ExpectVectorFromString("\x01P1\x02(777777)\x03\x21"),
                {
                    0x06 // <ACK>
                },
                __func__);
        ...
        void EnqueuePollRequests()
        {
            ...
            Expector()->Expect(
                    ExpectVectorFromString("\x01R1\x02""FREQU()\x03\x5c"),
                    ExpectVectorFromString("\x02""FREQU(49.97)\r\n\x03\x79"),
                    __func__);
    ...
    {
    protected:
        const char* ConfigPath() const { return "configs/config-energomera-ce102m-test.json"; }
    };
}
