...
protected:
    ...
    std::string GetTemplatePath() const { return "../wb-mqtt-serial-templates/"; }
...
void TLLSIntegrationTest::EnqueeCmdF0Response()
{
    ...
    {
        0x3E, 0x01, 0xF0, 0x1C, 0x06, 0x00, 0xA6, 0x13,
        0x00, 0x00, 0x9E, 0x11, 0x00, 0x00, 0xA0, 0x86,
        0x01, 0x00, 0xD4, 0x05, 0x00, 0x0A, 0x05, 0x68, 
    }, __func__);
}
...
void TLLSIntegrationTest::EnqueeCmdFCResponse()
{
    ...
    {
        0x3E, 0x01, 0xFC, 0x54, 0x57, 0x00, 0x00, 0xB0,
        0x00, 0x4F,
    }, __func__);
}
