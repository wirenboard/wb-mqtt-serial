...
void TSerialClientIntegrationTest::SetUp()
{
    ...
    Config = LoadConfig(GetDataFilePath("configs/config-test.json"),
                        ...
                        t,
                        rpcHandler,
                        [=](const Json::Value&, PRPCHandler rpcHandler) { return std::make_pair(Port, false); });
}
...
TEST_F(TSerialClientIntegrationTest, SlaveIdCollision)
{
    ...
    EXPECT_NO_THROW(
        LoadConfig(GetDataFilePath("configs/config-no-collision-test.json"),
                   DeviceFactory,
                   configSchema,
                   t,
                   rpcHandler,
    ...
    EXPECT_NO_THROW(
        LoadConfig(GetDataFilePath("configs/config-no-collision-test2.json"),
                   DeviceFactory,
                   configSchema,
                   t,
                   rpcHandler,
