...
TEST(TWinDecoTest, ParsePositionResponse)
{
    ...
    ASSERT_THROW(CheckExceptionMsg([]() { ParsePositionResponse(1, 1, {1, 0, 0, 1, 1, 2, 21}); }, "Bad CRC"),
                 TSerialDeviceTransientErrorException);

    ASSERT_THROW(CheckExceptionMsg([]() { ParsePositionResponse(1, 1, {2, 0, 0, 1, 1, 2, 22}); }, "Bad header"),
                 TSerialDeviceTransientErrorException);

    ASSERT_THROW(CheckExceptionMsg([]() { ParsePositionResponse(1, 1, {1, 0, 0, 1, 2, 2, 27}); }, "Bad address"),
                 TSerialDeviceTransientErrorException);

    ASSERT_THROW(CheckExceptionMsg([]() { ParsePositionResponse(1, 1, {1, 0, 0, 1, 1, 0xAA, 6}); }, "No limit setting"),
                 TSerialDeviceTransientErrorException);
    ...
    ASSERT_THROW(
        CheckExceptionMsg([]() { ParsePositionResponse(1, 1, {1, 0, 0, 1, 1, 0xAB, 0x0C}); }, "Unknown position"),
        TSerialDeviceTransientErrorException);
}
...
TEST(TWinDecoTest, ParseStateResponse)
{
    ...
    ASSERT_THROW(CheckExceptionMsg([]() { ParseStateResponse(1, 1, {1, 0, 0, 1, 1, 2, 21}); }, "Bad CRC"),
                 TSerialDeviceTransientErrorException);
    ASSERT_THROW(CheckExceptionMsg([]() { ParseStateResponse(1, 1, {2, 0, 0, 1, 1, 2, 22}); }, "Bad header"),
                 TSerialDeviceTransientErrorException);
    ASSERT_THROW(CheckExceptionMsg([]() { ParseStateResponse(1, 1, {1, 0, 0, 1, 2, 2, 27}); }, "Bad address"),
                 TSerialDeviceTransientErrorException);
}
