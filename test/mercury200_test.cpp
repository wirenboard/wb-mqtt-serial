...
void TMercury200Test::VerifyEnergyQuery()
{
    ...
    ASSERT_EQ(TChannelValue{0x62142}, Mercury200Dev->ReadRegisterImpl(Mercury200RET1Reg));
    ASSERT_EQ(TChannelValue{0x20834}, Mercury200Dev->ReadRegisterImpl(Mercury200RET2Reg));
    ASSERT_EQ(TChannelValue{0x11111}, Mercury200Dev->ReadRegisterImpl(Mercury200RET3Reg));
    ASSERT_EQ(TChannelValue{0x22222}, Mercury200Dev->ReadRegisterImpl(Mercury200RET4Reg));
...
void TMercury200Test::VerifyParamQuery()
{
    ...
    ASSERT_EQ(TChannelValue{0x1234}, Mercury200Dev->ReadRegisterImpl(Mercury200UReg));
    ASSERT_EQ(TChannelValue{0x5678}, Mercury200Dev->ReadRegisterImpl(Mercury200IReg));
    ASSERT_EQ(TChannelValue{0x765432}, Mercury200Dev->ReadRegisterImpl(Mercury200PReg));
    Mercury200Dev->InvalidateReadCache();
}
...
TEST_F(TMercury200Test, BatteryVoltageQuery)
{
    ...
    ASSERT_EQ(TChannelValue{0x0391}, Mercury200Dev->ReadRegisterImpl(Mercury200BatReg));
    SerialPort->Close();
}
