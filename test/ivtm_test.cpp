...
TEST_F(TIVTMDeviceTest, IVTM7MQuery)
{
    ...
    ASSERT_EQ(TChannelValue{0x41D1D3CE}, Dev->ReadRegisterImpl(Dev1Temp)); // big-endian
    ...
    ASSERT_EQ(TChannelValue{0x41EB9A30}, Dev->ReadRegisterImpl(Dev1Humidity)); // big-endian
    ...
    ASSERT_EQ(TChannelValue{0x41C7855E}, Dev->ReadRegisterImpl(Dev2Temp)); // big-endian
    SerialPort->Close();
}
